...
VALUES
        ('5ce422f9-7a4b-4f44-ad29-49c67cb32d2c','single bit one to decimal',2,'[1]',10,'{"digits":[1]}'),
        ('0cc3fea8-bb79-46ac-a2ab-5a2c93051033','binary to single decimal',2,'[1,0,1]',10,'{"digits":[5]}'),
        ('f12db0f9-0d3d-42c2-b3ba-e38cb375a2b8','single decimal to binary',10,'[5]',2,'{"digits":[1,0,1]}'),
        ('2c45cf54-6da3-4748-9733-5a3c765d925b','binary to multiple decimal',2,'[1,0,1,0,1,0]',10,'{"digits":[4,2]}'),
        ('65ddb8b4-8899-4fcc-8618-181b2cf0002d','decimal to binary',10,'[4,2]',2,'{"digits":[1,0,1,0,1,0]}'),
        ('8d418419-02a7-4824-8b7a-352d33c6987e','trinary to hexadecimal',3,'[1,1,2,0]',16,'{"digits":[2,10]}'),
        ('d3901c80-8190-41b9-bd86-38d988efa956','hexadecimal to trinary',16,'[2,10]',3,'{"digits":[1,1,2,0]}'),
        ('5d42f85e-21ad-41bd-b9be-a3e8e4258bbf','15-bit integer',97,'[3,46,60]',73,'{"digits":[6,10,45]}'),
        ('d68788f7-66dd-43f8-a543-f15b6d233f83','empty list',2,'[]',10,'{"digits":[0]}'),
        ('5e27e8da-5862-4c5f-b2a9-26c0382b6be7','single zero',10,'[0]',2,'{"digits":[0]}'),
        ('2e1c2573-77e4-4b9c-8517-6c56c5bcfdf2','multiple zeros',10,'[0,0,0]',2,'{"digits":[0]}'),
        ('3530cd9f-8d6d-43f5-bc6e-b30b1db9629b','leading zeros',7,'[0,6,0]',10,'{"digits":[4,2]}'),
